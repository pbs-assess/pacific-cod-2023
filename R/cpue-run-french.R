...
if(!file.exists(file.path(generatedd,paste0("CPUE_All_Fully_Standardized_3CD_french.png")))) {
  params <- list()
  ...
  # write to file
  ggsave(file.path(generatedd,paste0("CPUE_All_Fully_Standardized_3CD_french.png")))
