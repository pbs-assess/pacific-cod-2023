...
```{r fig-sens-recr-3cd-sigw, fig.cap="Sensitivity of recruitment estimates to the 2019 annual mean weight index point (see Table 1). Points shows the posterior medians and the bars represent the 95\\% credible interval. The lower panel is zoomed in to 2015--2022.", fig.asp=.9}
...
```{r fig-sens-biomass-3cd-sigw, fig.cap="Sensitivity of biomass estimates to the 2019 annual mean weight index point (see Table 1). Thick solid lines shows the posterior medians and the grey shaded regions represent the 95\\% credible interval. The lower panel is zoomed in to 2015--2022.", fig.asp=.9}
