...
However, given the three low index points in 2018, 2021 and 2022, Science has issued a RSIA requesting a stock status update to ensure all three of these index points are considered in a timely evaluation of stock status.
...
This report evaluates four different treatments of the commercial annual mean weight index for 2018-2022 in a delay-difference model configured in the same way as the 2018 and 2020 reference models [@forrest2020; @dfo2021].
The four different treatments of the commercial annual mean weight index include two scenarios that use recent index values derived from the GLM presented to the TWG in 2022 (Appendices B and C), and two that do not. 
...
Model diagnostics are shown in Appendix D.
...
The scenarios without the GLM values (Sc. 3 and 4) estimated slightly higher biomass for 2020--2022 than Sc. 1 and 2 (Table \@ref(tab:tab-est-biomass-3cd-per)), but the maximum percentage difference was only 7.8% (Sc. 3 compared to Sc. 1 in 2021), noting that Sc. 3 and 4 did not fit the mean weight index.
...
**Given the consistency of the GLM-derived commercial mean weight index with other data sources, and the small differences in biomass estimates among scenarios, we recommend using Sc. 1 for all the models in the model-averaging set for estimating stock status.**
...
We note that other Pacific Cod populations (notably in Alaska) have undergone large declines since the "marine heatwave" of 2015 and 2016 [e.g., @barbeaux2020; @laurel2020].
