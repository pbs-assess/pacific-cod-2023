...
This reprot uses the same model configurations as the 2018 and 2020 assessments [@forrest2020; @dfo2021], including model-averaged stock status based on the same seven sensitivity scenarios as in 2018 and 2020.
The impacts of different treatments of the commercial mean weight index are evaluated, including two scenarios that use recent index values derived from the GLM presented to the TWG in 2022 (Appendices B and C). 
We are seeking feedback on which commercial mean weight index from one of these scenarios to use in the seven models to estimate stock status. 
