...
```{r fig-meas-vs-calc-index-compare-2, fig.cap="Comparison of the survey annual mean weight index calculated with observed weights vs calculated weights", out.width="4in", echo = FALSE}
