...
Given the obvious problems with basing index points on such limited samples, we don't think it is justified to include the 2017 data point or to change model parameters.
