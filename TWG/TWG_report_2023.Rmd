...
Note that there may be minor differences in the mean weight index compared to that calculated in @forrest2020 due to routine updates of the databases (for example, in 2022 it was discovered that some Pacific Cod length samples had been incorrectly coded as total length instead of fork length).
