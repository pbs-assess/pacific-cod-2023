...
Due to lack of samples, the 2020 assessment used the 2019 mean weight value for both 2019 and 2020 [@dfo2021].
However, we note that the 2019 index point was also based on only two samples.
Therefore a methodology was developed for predicting the commercial mean weight index from a mean weight index derived from length samples taken in the WCVI Synoptic Survey.
...
The methodology is described here in Appendix B and C.
