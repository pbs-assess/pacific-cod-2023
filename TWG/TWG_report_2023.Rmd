...
Posterior estimates of biomass from the seven sensitivity models are shown in Figure \@ref(fig:fig-model-average-biomass-3cd).
Estimates of recruitment and fishing mortality are shown in Figures \@ref(fig:fig-model-average-recruit-3cd) and \@ref(fig:fig-model-average-f-3cd).
