...
Using the `predict` function in R, we then used the model to predict commercial mean weights from survey mean weights. 
Note that we included the 2021 survey indices for both areas in the regression model.
