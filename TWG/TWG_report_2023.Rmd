...
We use the survey mean weight index to predict the commercial mean weight index for only the last four years of the assessment so that we can have a continuous mean weight index for the entire model period, beginning in 1956.
...
# Generalized Linear Model to predict commercial mean length index {#sec:AppendixB}

xxx

\clearpage

# Model diagnostics {#sec:AppendixC}
