...
### Commercial annual mean weigh index
...
The model fit the commercial mean weight index very well for Sc. 1 and 2, which used values from the GLM from 2018 onwards, with and without interpolation, respectively (Figures \@ref(fig:fig-base-mean-weight-3cd) to \@ref(fig:fig-base-mean-weight-3cd-sc2)). 
The fit was very similar for both scenarios. 
The models without GLM values (Sc. 3 and 4) poor fit to the commercial mean weight index from 2018 onwards (Figures \@ref(fig:fig-base-mean-weight-3cd-sc3) to \@ref(fig:fig-base-mean-weight-3cd-sc4)).
...
This pattern is consistent with predicted recruitment from all four models (Table \@ref(tab:tab-est-recruit-3cd)), which estimate a large decline in recruitment between 2016 and 2018.
A population with fewer recruits is expected to have a higher than average mean weight of individuals.
The models predicted an increase in recruitment between 2019 and 2022 , which would result in the subsequent decrease in estimated mean weight (Table \@ref(tab:tab-est-recruit-3cd), Figure \@ref(fig:fig-sens-recr-3cd)).
All four models showed a similar pattern (Table \@ref(tab:tab-est-recruit-3cd-per)), indicating that other data sources had a greater influence on model estimates than the commercial mean weight index, i.e., the declines in the survey index, commercial catches and commercial CPUE.
This indicates that the survey mean weight index, used to predict the commercial mean weight index in Sc. 1 and 2, is consistent with other data sources and better indexes mean weight patterns than attempting to extrapolate from the last observations of the commercial mean weight index (Sc. 3 and 4).
