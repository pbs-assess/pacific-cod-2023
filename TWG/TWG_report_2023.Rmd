...
Standardized commercial CPUE indices were developed for the historical (1956--1995) and modern (1996--2019) periods.
...
However, even before the COVID-19 pandemic, there had been a decline in commercial sampling of Pacific cod since 2015 (Appendix A of this document). 
...
Due to lack of samples, the 2020 assessment update used the 2019 mean weight value for both 2019 and 2020 [@dfo2021].
However, we note that the 2019 index point was also based on only two samples.
A methodology for predicting the commercial mean weight index from a mean weight index derived from length samples taken in the WCVI Synoptic Survey is described in Appendix B and C.
