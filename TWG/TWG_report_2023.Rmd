...
```{r fig-comm-vs-survey-weights-3cd, fig.cap="Commercial mean weight index and survey mean weight index. Size of the circles indicates the number of sampling events. For visualization purposes, the commercial mean weight index is truncated to begin in 2000.", out.width="4in"}
...
Note that the observed 2017 and 2019 commercial mean weight index points were removed from the analysis due to the low sample sizes they were based on (Appendix A).
However, they would have no impact on the results anyway, since there were no surveys in these years.
