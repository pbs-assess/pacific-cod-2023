...
summary_by_year <- comm_samp %>%
 ...
 colnames(summary_by_year) <- c("Année", "Nbre échantillons", "Nbre longueurs", "Longueur moyenne brute","Écart-type longueur", "Erreur-type longueur")
...
# Appendix B. Développement d'indice de poids moyen
...
# Appendix C. Modèle linéaire généralisé pour prédire l'indice de poids moyen commercial 
...
# Appendix D. Sensibilité du modèle au traitement de l’indice de poids moyen
