...
Given the poor predictive power of the GLM for predicting a commercial mean weight index for the Area 5ABCD population (DFO unpublished report), there is already no clear path forward for that stock.
