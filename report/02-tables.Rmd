...
make.parameters.table(base.model.3cd,
  caption = paste0("Estimated and fixed parameters and prior probability distributions used ",
    "in the Reference model. The survey catchability parameter for WCVI ($q_1$) was estimated with the prior probability distribution $\\textrm{Normal}(ln(0.228),0.3)$. The other survey catchability parameters were estimated without priors."),
