...
Given the low index point in 2018, the 2020 Science Response recommended updating the assessment when 2020 survey information became available [@dfo2021].
...
The commercial CPUE index decreased substantially in 2018 but has increased slightly since then, with increases in commercial catch (Figure \@ref(fig:fig-summary-cpue-indices-3cd), Table \@ref(tab:tab-catch-3cd)).
