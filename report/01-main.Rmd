...
**We acknowledge that a new dockside biosampling program is currently in the pilot stage, with the intention of expanding to a full coastwide program following the pilot program.**
...
Therefore, in the absence of resuming **an at-sea** commercial biological sampling program, we recommend resources be allocated to investigating and comparing other approaches for providing catch advice for Pacific Cod stocks.
