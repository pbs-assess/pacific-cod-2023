...
## Description of the fishery {#sec:fishery}
...
# Analysis and Response {#sec:analysis-and-response}
...
### Commercial catch {#sec:comm-catch}
...
### Canadian bottom trawl surveys {#sec:surveys}
...
### NMFS Triennial Survey (in Canadian waters) {#sec:nmfs-survey}
...
### Annual mean weight in commercial catch {#sec:mean-weight-index}
...
The model was largely insensitive to these alternative treatments, mainly because the GLM-derived index values were consistent with the other data sources in the model (see Section \@ref{sec:ref-results}), resulting in poor fits to alternative versions of the index and, therefore, little impact on recruitment and biomass estimates.

## Stock assessment model {#sec:assessment}
...
See Section \@ref(sec:scenarios) for details.
...
## Reference model results {#sec:ref-results}
...
## Indicators of current stock status {#sec:status}
...
## Sources of uncertainty {#sec:uncertainty}
