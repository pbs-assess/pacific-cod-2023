...
The 2020 assessment for Pacific Cod (*Gadus macrocephalus*) in British Columbia (BC) found the Area 3CD stock (West Coast Vancouver Island: WCVI; Figure \@ref(fig:fig-map)) to be in the Cautious Zone with > 99% probability [@dfo2021] with < 1% probability of being in the Critical Zone.
...
The stock assessment model is a Bayesian delay-difference model [@deriso1980], fit to survey indices, commercial CPUE indices, commercial catch data, and and the commercial mean weight index.
