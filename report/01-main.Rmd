...
The 2020 assessment for Pacific Cod (*Gadus macrocephalus*) in British Columbia (BC) found the Area 3CD stock (West Coast Vancouver Island: WCVI; Figure \@ref(fig:fig-map)) to be in the Cautious Zone with > 99% probability [@dfo2021].
...
The commercial CPUE index decreased substantially in 2018 but has since increased, following increases in commercial catch (Figure \@ref(fig:fig-summary-cpue-indices-3cd)).
...
This follows a trend of reduced biological length sampling of Pacific Cod on commercial vessels that began around 2015 (Appendix A).
...
The TWG found that the GLM provided acceptable predictions of the commercial mean weight index for the Area 3CD stock but decided that the GLM did not have acceptable predictive power for the 5ABCD stock.
Because of this issue with the 5ABCD stock commercial mean weight index and limited staff resources, Step 2 did not proceed.
...
Table \@ref(tab:summary-tab-projection-zero-avg-3cd) indicates a 16% probability (i.e., about 3 out of 20 chance) that the stock would be below the limit reference point at the beginning of 2024 under a zero catch policy.
